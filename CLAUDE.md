...
- **Conteúdo** de outros exames além do AZ-900. O caminho de código está pronto e testado: `AzurePrepDbSeeder.Exames` é uma lista de `DefinicaoDeExame`, e adicionar AZ-104/305/400 é uma entrada nela mais os JSONs — sem mudança de algoritmo, e a tela inicial já lista todos os exames publicados. **Os quatro exames já estão declarados**, todos com pesos conferidos no study guide oficial e os três novos em `Publicado: false`:
...
| AZ-305 | 4 | 50 em 120 min | 17/04/2026 | 22 (1/4 domínios) |
| AZ-400 | 5 | 50 em 120 min | 27/07/2026 | 22 (1/5 domínios) |

⚠️ No AZ-400, o domínio `pipelines` vale **50–55% sozinho** — um banco equilibrado entre os cinco daria prova enviesada. O que falta é o caro: ~350 questões originais por exame, no nível calibrado que a seção de metodologia descreve.
